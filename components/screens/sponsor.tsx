    ...
    <div className="relative w-full min-h-[400px] flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-8 max-w-4xl mx-auto">
        ...
        <h1 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold">
          Purple Box Moving Company&apos;s is brought to you for <span className="text-[#9A4CB9] ">FREE</span> thanks to our sponsors
        </h1>
        ...
        {/* Learn More Button */}
        <Link href="/main/terms" className="bg-[#9A4CB9] hover:bg-[#9A4CB9]/80 text-black  font-bold px-8 py-1 rounded text-lg transition-colors duration-200">
          Learn More
        </Link>
      </div>
    </div>
