...
const content = () => {
  ...
  <div className=' w-full mx-0 md:mx-10'>
   ...
   <span className='text-[#9A4CB9]'>Dial in your desktop CNC router</span> - Easier cutting starts here
    </h1>
    <h1 className="text-lg  mt-5 sm:mt-5 md:text-2xl lg:text-3xl  font-bold ">
    <span>Optimized feeds and speeds for desktop CNC machines.</span> <span  className='text-[#9A4CB9]'>Just
    select and cut.</span> 
    </h1>
