...
export default function AdjustMultiplierModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center  p-4 ">
      <div className="bg-[#004851] border-4 border-[#9A4CB9] rounded-lg p-6 w-full max-w-sm relative text-white">
        <button
          onClick={onClose}
        ...
        <button
            ...
            className="bg-[#9A4CB9] text-[#004851] p-2 rounded-md hover:bg-[#9A4CB9]/80"
          >
            <Minus size={24} />
          </button>
          <input
        ...
        <button
          ...
          className="w-full bg-[#9A4CB9] text-white font-bold py-2 rounded-md mb-4 hover:bg-[#9A4CB9]/80 transition-colors"
        >
          Save
        </button>
        ...
        <p className="text-sm text-center mb-4">
         ...
         <button
          onClick={handleShare}
          disabled={isSharing}
          className="w-full bg-[#9A4CB9] text-[#004851] font-bold py-2 rounded-md hover:bg-[#9A4CB9]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
