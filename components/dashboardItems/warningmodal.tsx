...
export default function WarningModal({
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center mt-6 m-4">
      <div className="bg-[#004851] m-1 border-[5px] border-[#9A4CB9] rounded-lg p-6 w-full max-w-[22rem] w-[-5px] relative text-white text-center ">
        <button
          onClick={onClose}
        ...
        <button
          ...
          className="w-full bg-[#9A4CB9] text-[#004851] font-bold py-2 rounded-md hover:bg-[#9A4CB9]/80 transition-colors"
        >
          Proceed
        </button>
      </div>
