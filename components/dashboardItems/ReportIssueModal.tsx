...
const ReportIssueModal = ({ open, onClose }: ReportIssueModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-[#004851] border-4 border-[#9A4CB9] rounded-lg p-6 w-full max-w-md relative text-white">
        <button
          onClick={onClose}
        ...
        <h2 className="text-[#9A4CB9] text-2xl font-bold mb-2">Report An Issue</h2>
